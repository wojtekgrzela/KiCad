...
//2553333/209683/2.48/8/3/MOSFET P-Channel
...
(library Library_1
	...
	(symbolDef "APM4953" (originalName "APM4953")
	...
	(compDef "APM4953" (originalName "APM4953") (compHeader (numPins 8) (numParts 1) (refDesPrefix Q)
		)
		...
		(compPin "8" (pinName "D1_2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "D1_1") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "D2_2") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "D2_1") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "APM4953"))
		...
		(attr "Manufacturer_Name" "Guangdong Hottech")
		(attr "Manufacturer_Part_Number" "APM4953")
		(attr "Mouser Part Number" "")
		(attr "Mouser Price/Stock" "")
		(attr "Arrow Part Number" "")
		(attr "Arrow Price/Stock" "")
		(attr "Description" "P-Channel Enhancement Mode Power MOSFET")
		(attr "<Hyperlink>" "https://datasheet.lcsc.com/szlcsc/Guangdong-Hottech-4953_C181099.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "APM4953.stp")
