...
(library Library_1
	...
	(patternDef "G5NB1A4DC5" (originalName "G5NB1A4DC5")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 10.250, 0.000) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt 0 3.6) (pt 20.5 3.6) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 20.5 3.6) (pt 20.5 -3.6) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 20.5 -3.6) (pt 0 -3.6) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 0 -3.6) (pt 0 3.6) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "G5NB-1A-E-DC5V" (originalName "G5NB-1A-E-DC5V") (compHeader (numPins 4) (numParts 1) (refDesPrefix K)
		...
		(attr "Description" "")
		(attr "<Hyperlink>" "https://omronfs.omron.com/en_US/ecb/products/pdf/en-g5nb.pdf")
		(attr "<Component Height>" "15")
		(attr "<STEP Filename>" "G5NB-1A-E-DC5V.stp")
